const popularDorks = [
  ...
  'inurl:config | inurlenv | inurl:setting | inurl:backup | inurl:admin | inurl:php',
  'inurl:email= | inurl:phone= | inurl:password= | inurl:secret= inurl:& inurl:apidocs | inurl:api-docs | inurl:swagger | inurl:api-explorer',
